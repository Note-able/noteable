...
module.exports = function (_React$Component) {
  ...
  function AudioComponent(props, context) {
    _classCallCheck(this, AudioComponent);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AudioComponent).call(this, props, context));
      ...
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            'audio',
            { controls: true },
            React.createElement('source', { src: this.state.audioUrl, type: 'audio/mpeg' })
          )
        )
      );
    }
