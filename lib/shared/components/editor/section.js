  ...
  _createClass(Section, [{
    ...
    value: function handleKeyDown(e) {
      ...
      if (e.keyCode === KeyCodes.enter) {
        ...
        if (this.keyMap[KeyCodes.alt] && (e.metaKey || e.ctrlKey)) {
          e.preventDefault();
          if (this.props.section.lineData[this.props.section.selectedIndex].type !== 'chord' && this.props.section.lineData[this.props.section.selectedIndex - 1].type !== 'chord') this.props.dispatch(addLine(this.props.sectionId, ++this.lines, this.props.section.selectedIndex, 'chord', null, true, window.getSelection().baseOffset));else this.props.dispatch(_updateSelected(this.props.sectionId, this.props.section.selectedIndex - 1, window.getSelection().baseOffset));
        }
      }
    }
  }, {
    ...
    value: function showTooltip(selection) {
      ...
      const tooltip = ReactDOM.render(React.createElement(Tooltip, { element: selection.anchorNode.parentElement, rect: rect }), this.refs.tooltip);
    ...
    value: function render() {
      ...
      const lineElements = lineData.map(line => {
        if (line.type === 'text') {
          ...
          const selected = line.lineId === this.props.section.lineData[this.props.section.selectedIndex].lineId;
          const offset = selected ? this.props.section.offset : 0;
          return React.createElement(ChordLine, { key: line.lineId,
            ref: `line${ line.lineId }`,
            lineId: line.lineId,
            text: line.text,
            offset: offset,
            type: line.type,
            updateSelectedToTextLine: () => {
              this.props.dispatch(_updateSelected(this.props.sectionId, this.props.section.selectedIndex + 1, 0));
            },
            updateSelected: this.updateSelected.bind(this) });
        }
      });
