...
class Section extends React.Component {
  ...
  // the selection get split when there are already chords in a line
  /* possible solution:
  1. Add text block nodes that have starting indices
  2. Get the line when addChord is called
  3. get the text block we are in
  4. Add chord at text block index + selection offset.
  */
  addChord() {
