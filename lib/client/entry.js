...
render(React.createElement(
  ...
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        Route,
        { path: '/events', component: EventController },
        React.createElement(Route, { path: '/events/browse', components: BrowseEvents }),
        React.createElement(Route, { path: '/events/create', components: CreateEvent }),
        React.createElement(Route, { path: '/profile', components: Profile }),
        React.createElement(Route, { path: '/profile/demo', components: DemoProfile })
      ),
