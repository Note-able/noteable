...
exports.messageMapper = exports.conversationsMapper = exports.conversationMapper = undefined;
...
var conversationsMapper = function conversationsMapper(users, conversations) {
  users = users.reduce(function (map, user) {
    map[user.id] = user;return map;
  }, {});
  var conversationMap = conversations.reduce(function (map, conversation) {
    ...
    if (map[conversationid]) map[conversationid].users.push(users[user.user_id]);else map[conversationid] = { users: [users[user.user_id]], lastMessage: { id: message_id, content: message_content, userId: message_user_id } };
    return map;
  }, {});
...
var messageMapper = exports.messageMapper = function messageMapper(dbMessage) {};