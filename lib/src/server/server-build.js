...
(0, _reactDom.render)(_react2.default.createElement(_reactRedux.Provider, { store: store }, _react2.default.createElement(_reactRouter.Router, { history: createBrowserHistory() }, _react2.default.createElement(_reactRouter.Route, { path: '/', component: AppController }, _react2.default.createElement(_reactRouter.Route, { path: '/signin', component: SigninController }), _react2.default.createElement(_reactRouter.Route, { path: '/success', component: SuccessDisplayController }), _react2.default.createElement(_reactRouter.Route, { path: '/editor', component: Editor }), _react2.default.createElement(_reactRouter.Route, { path: '/editor/:documentId', component: EditorController }), _react2.default.createElement(_reactRouter.Route, { path: '/audio', component: AudioComponent }), _react2.default.createElement(_reactRouter.Route, { path: '/events', component: EventController }), _react2.default.createElement(_reactRouter.Route, { path: '/events/browse', components: BrowseEvents }), _react2.default.createElement(_reactRouter.Route, { path: '/events/create', components: CreateEvent }), _react2.default.createElement(_reactRouter.Route, { path: '/profile(/:profileId)', components: Profile }, _react2.default.createElement(_reactRouter.Route, { path: '/profile/create', component: _create2.default })), _react2.default.createElement(_reactRouter.Route, { path: '/profile/demo', components: DemoProfile })), _react2.default.createElement(_reactRouter.Route, { path: '/songs', component: SongsController }))), node);
'use strict';
...
module.exports = (_temp = _class = function (_Component) {
  ...
  _createClass(AppController, [{
    ...
    value: function renderGrid() {
      return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'testing-verticals' }), _react2.default.createElement('div', { className: 'testing-horizontal' }));
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', null, _react2.default.createElement('link', { href: '/css/bundle.css', rel: 'stylesheet', type: 'text/css' }), _react2.default.createElement('link', { href: 'https://fonts.googleapis.com/css?family=Lobster', rel: 'stylesheet' }), this.props.location.pathname === '/' ? this.renderHome() : this.props.children);
    }
  }]);
...
module.exports = (_temp2 = _class = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'login-container' }, _react2.default.createElement('div', { className: 'login-container__header' }, 'Sign In'), _react2.default.createElement('div', { className: 'signin-form' }, this.state.loginFailed ? _react2.default.createElement('div', { className: 'signin-form__error-message' }, 'Invalid username or password') : null, _react2.default.createElement('input', { className: 'signin-form__username', name: 'email', onChange: function onChange() {
        ...
        } }), _react2.default.createElement('button', { className: 'signin-form__submit-button', onClick: function onClick() {
          return _this3.login();
        } }, 'Submit')), _react2.default.createElement('div', { className: 'button-container' }, _react2.default.createElement('a', { href: 'auth/facebook' }, _react2.default.createElement('button', { className: 'button-container__submit-button', onClick: function onClick() {
          return _this3.facebookLogin();
        } }, 'Login with Facebook'))), _react2.default.createElement('div', { className: 'button-container' }, _react2.default.createElement('div', { className: 'button-container__open-register', onClick: function onClick() {
...
module.exports = function (_React$Component) {
  ...
  _createClass(Logout, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "logout-button" }, React.createElement("button", { className: "logout-button__submit-button", onClick: this.logout }, "Logout of Facebook"));
    }
  }]);
...
module.exports = (_temp2 = _class = function (_Component) {
  ...
  _createClass(Register, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'register-container' }, _react2.default.createElement('div', { className: 'register-container__header' }, 'Register'), _react2.default.createElement('div', { className: 'register-form' }, this.state.registerFailed ? _react2.default.createElement('div', { className: 'register-form__error-message' }, 'Email already exists') : null, _react2.default.createElement('input', { className: 'register-form__username', name: 'name', onChange: function onChange() {
          return _this3.updateForm();
        ...
        } }, 'Submit')), _react2.default.createElement('div', { className: 'button-container' }, _react2.default.createElement('button', { className: 'button-container__submit-button', onClick: function onClick() {
          return _this3.facebookLogin();
        } }, 'Sign up with Facebook')), _react2.default.createElement('div', { className: 'button-container' }, _react2.default.createElement('div', { className: 'button-container__open-register', onClick: function onClick() {
...
module.exports = (_temp2 = _class = function (_Component) {
  ...
  _createClass(Chord, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement('span', { className: 'editor-chord-container' }, _react2.default.createElement('span', { contentEditable: 'false' }, _react2.default.createElement('span', {
...
var EditorComponent = function (_Component) {
  ...
  _createClass(EditorComponent, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'editor', contentEditable: 'false' }, _react2.default.createElement('button', { className: 'submitButton', onClick: function onClick() {
          return _this4.submitRevision;
        } }, ' Submit Revision'), sectionElements);
    }
  }]);
...
var RecordingLine = function RecordingLine() {
  return _react2.default.createElement('div', { className: 'editor-recording' }, _react2.default.createElement('span', { contentEditable: 'false' }, _react2.default.createElement(AudioComponent, null)));
};
  ...
  _createClass(Section, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', {
        ...
        suppressContentEditableWarning: true
      }, lineElements, _react2.default.createElement('div', { ref: function ref(_ref3) {
...
var TextBlock = function (_Component) {
  ...
  _createClass(TextBlock, [{
    key: "render",
    value: function render() {
      return React.createElement("span", { className: "editor-text-block", "data-index": this.props.index }, this.props.text);
    }
  }]);
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { ref: function ref(_ref) {
        ...
        }, className: 'editor-tooltip', style: tooltipStyle }, _react2.default.createElement('div', { className: 'tooltip-option', onMouseDown: function onMouseDown() {
          return _this2.handleMouseDown(_this2.props.addRecordingLine);
        } }, 'Record'), _react2.default.createElement('div', { className: 'tooltip-option', onMouseDown: function onMouseDown() {
...
var EditorController = function (_Component) {
  ...
  _createClass(EditorController, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'editor-container' }, _react2.default.createElement('div', { className: 'record' }, _react2.default.createElement(AudioRecord, null)), _react2.default.createElement(Editor, {
        sectionDispatch: this.props.sectionDispatch,
        routeParams: this.props.routeParams,
        sectionData: this.props.editor.sectionData
      }), _react2.default.createElement('div', { className: 'messages-container' }, _react2.default.createElement('div', { className: 'messages-wrapper' }, _react2.default.createElement(MessageFeed, {
...
module.exports = function (_React$Component) {
  ...
  _createClass(EventController, [{
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "event-controller-container" }, this.props.children);
    }
  }]);
  ...
  _createClass(BrowseEvents, [{
    ...
    value: function renderView() {
      if (this.state.mode === 'list') {
        return React.createElement('div', { className: 'events-list-container' }, React.createElement(EventsListView, { events: this.state.events }));
      }

      return React.createElement('div', { className: 'events-map-container' }, React.createElement(EventsMapView, { events: this.state.events }));
    }
  }, {
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'events-container' }, React.createElement('div', { className: 'view-toggle-bar' }, React.createElement('div', { className: 'toggle' }, React.createElement('div', { className: 'toggle__option list-view', onClick: this.selectListView }, 'List'), React.createElement('div', { className: 'toggle__option map-view', onClick: this.selectMapView }, 'Map'), React.createElement('div', { className: 'toggle__option highlight', style: this.state.mode === 'list' ? left : right }))), React.createElement('div', { className: 'events-view' }, this.renderView()));
    }
  }]);
...
var Calendar = function (_React$Component) {
  ...
  _createClass(Calendar, [{
    ...
    value: function renderTimeError() {
      return React.createElement('div', { className: 'time-error' }, this.state.errorMessage);
    }
  }, {
    key: 'renderMonth',
    value: function renderMonth() {
      ...
      var rows = new Array(rowNum).fill(0).map(function (zero, index) {
        return React.createElement('tr', { key: index + 'week', className: 'calendar-week' }, new Array(7).fill(0).map(function (fill, weekday) {
          var day = date.date();
          if (day > weekday && index === 0) {
            date.add(1, 'days');
            return React.createElement('td', { className: 'day', key: day, onClick: _this2.backMonth, style: { color: '#ccc' } }, day);
          }

          if (date.month() > month) {
            date.add(1, 'days');
            return React.createElement('td', { className: 'day', key: day, onClick: _this2.forwardMonth, style: { color: '#ccc' } }, day);
          }

          date.add(1, 'days');
          return React.createElement('td', { className: 'day', key: day, onClick: _this2.selectDate }, day);
        }));
      });

      return React.createElement('table', null, React.createElement('tbody', null, React.createElement('tr', null, React.createElement('th', { colSpan: '7' }, React.createElement('span', { className: 'left-selector selector', onClick: this.backMonth }, '<'), React.createElement('span', null, Moment(this.state.activeDate).format('MMMM') + ' ' + Moment(this.state.activeDate).format('YYYY')), React.createElement('span', { className: 'right-selector selector', onClick: this.forwardMonth }, '>'))), React.createElement('tr', null, React.createElement('th', null, 'S'), React.createElement('th', null, 'M'), React.createElement('th', null, 'T'), React.createElement('th', null, 'W'), React.createElement('th', null, 'TH'), React.createElement('th', null, 'F'), React.createElement('th', null, 'S')), rows));
    }
  }, {
    key: 'renderCalendarPopup',
    value: function renderCalendarPopup() {
      return React.createElement('div', { className: 'calendar-popup', style: { background: 'white', position: 'absolute', top: this.state.tooltipTop + 'px', left: this.state.tooltipLeft + 'px', padding: '4px', textAlign: 'center' } }, this.renderMonth());
    }
  }, {
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'calendar-date-picker-container', ref: 'parent', onClick: this.closeTooltips }, this.state.invalidTime ? this.renderTimeError() : null, React.createElement('input', { className: 'calendar-date start', style: this.state.parentWidth < 300 ? { width: '100%' } : { width: '50%' }, value: this.state.startDate, onChange: this.onDateChange, onFocus: this.onFocusStart, onKeyDown: this.onKeyDown, placeholder: 'MM/DD/YYYY', ref: 'startDate' }), this.state.showTooltipStartDate ? this.renderCalendarPopup() : null, React.createElement('div', { className: 'picker-container', onClick: this.closeTooltips, style: this.state.parentWidth < 300 ? { display: 'flex', width: '100%' } : { display: 'inline-flex', width: '50%' } }, React.createElement('select', { value: this.state.startHour, onChange: this.selectDate, className: 'start-hour-picker select' }, hour.map(function (time) {
        return React.createElement('option', { key: time + '-hour-start', value: time }, time);
      })), React.createElement('select', { value: this.state.startMinute, onChange: this.selectDate, className: 'start-minute-picker select' }, minute.map(function (time) {
        return React.createElement('option', { key: time + '-minute-start', value: time }, time);
      })), React.createElement('select', { value: this.state.startKind, onChange: this.selectDate, className: 'start-kind-picker select' }, React.createElement('option', { value: 'AM' }, 'AM'), React.createElement('option', { value: 'PM' }, 'PM'))), React.createElement('input', { className: 'calendar-date', style: this.state.parentWidth < 300 ? { width: '100%' } : { width: '50%' }, value: this.state.endDate, onChange: this.onDateChange, onFocus: this.onFocusEnd, onKeyDown: this.onKeyDown, placeholder: 'MM/DD/YYYY', ref: 'startDate' }), this.state.showTooltipEndDate ? this.renderCalendarPopup() : null, React.createElement('div', { className: 'picker-container', onClick: this.closeTooltips, style: this.state.parentWidth < 300 ? { display: 'flex', width: '100%' } : { display: 'inline-flex', width: '50%' } }, React.createElement('select', { value: this.state.endHour, onChange: this.selectDate, className: 'end-hour-picker select' }, hour.map(function (time) {
        return React.createElement('option', { key: time + '-hour-end', value: time }, time);
      })), React.createElement('select', { value: this.state.endMinute, onChange: this.selectDate, className: 'end-minute-picker select' }, minute.map(function (time) {
        return React.createElement('option', { key: time + '-minute-end', value: time }, time);
      })), React.createElement('select', { value: this.state.endKind, onChange: this.selectDate, className: 'end-kind-picker select' }, React.createElement('option', { value: 'AM' }, 'AM'), React.createElement('option', { value: 'PM' }, 'PM'))), React.createElement('style', null, styles));
    }
  }]);
...
module.exports = function (_React$Component) {
  ...
  _createClass(CreateEvent, [{
    ...
    value: function renderComponent() {
      return React.createElement('div', { className: 'event-form' }, React.createElement('div', { className: 'event-form-wrapper' }, React.createElement('label', { 'for': 'name' }, 'Name'), React.createElement('input', { name: 'name', className: 'event-name', onChange: this.changeName, type: 'text', placeholder: 'Name' }), React.createElement('label', null, 'Date'), React.createElement(Calendar, { onChange: this.handleDateChange }), React.createElement('label', { 'for': 'location' }, 'Location'), React.createElement('input', { name: 'location', className: 'map-search', ref: 'searchBox', type: 'text', placeholder: 'Search Box' }), React.createElement('label', { 'for': 'notes' }, 'Notes'), React.createElement('textarea', { name: 'notes', className: 'event-notes', type: 'text', placeholder: 'Leave a note or description.' }), React.createElement('button', { className: 'submit-event', onClick: this.createEvent, disabled: this.state.positionSet && this.state.nameSet && this.state.dateIsValid ? false : 'disabled' }, 'Submit')));
    }
  }, {
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'create-event-container' }, React.createElement('div', { id: 'map' }), this.state.loading ? this.renderLoader() : this.renderComponent());
    }
  }]);
...
module.exports = function (_React$Component) {
  ...
  _createClass(Event, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'event-container' }, React.createElement('span', null, this.state.event.name), React.createElement('span', null, this.state.event.latitude, '+', this.state.event.longitude), React.createElement('span', null, this.state.event.notes));
    }
  }]);
...
module.exports = function (_React$Component) {
  ...
  _createClass(EventsListView, [{
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'events-list-container' }, this.props.events.map(function (event) {
...
module.exports = function (_React$Component) {
  ...
  _createClass(EventsListView, [{
    ...
    key: 'render',
    value: function render() {
      return React.createElement('div', { className: 'events-map-container' }, React.createElement('input', { name: 'location', className: 'map-search', ref: 'searchBox', type: 'text', placeholder: 'Search Box' }), React.createElement('div', { id: 'map' }), React.createElement('div', { className: 'events-list-container' }, this.props.events.map(function (event) {
        console.log(event);
        return React.createElement(Event, { key: event.id, event: event });
      })));
    }
...
var HomeController = function (_Component) {
  ...
  _createClass(HomeController, [{
    ...
    value: function renderUserOptions() {
      return _react2.default.createElement('div', { className: 'user-options' }, _react2.default.createElement('a', { href: '/profile' }, _react2.default.createElement('div', { className: 'dropdown-button' }, 'Profile')), _react2.default.createElement('a', { href: '/editor' }, _react2.default.createElement('div', { className: 'dropdown-button' }, 'Editor')), _react2.default.createElement('a', { href: '/logout' }, _react2.default.createElement('div', { className: 'dropdown-button' }, 'Sign out')));
    }
  }, {
    ...
    value: function renderAuthenticationOptions() {
      ...
      if (this.props.isAuthenticated) {
        return _react2.default.createElement('a', { className: 'user-options-menu', onClick: this.state.showUserOptions ? null : this.showOptions }, _react2.default.createElement('div', { className: 'home' }));
      }

      return _react2.default.createElement('a', { onClick: function onClick() {
          return _this3.showSignIn();
        } }, _react2.default.createElement('div', { className: 'signin-button' }, 'Sign in'));
    }
  }, {
    ...
    value: function renderSignInDialog() {
      ...
      return [_react2.default.createElement('div', { className: 'signin-background', onClick: function onClick() {
        ...
        } }), _react2.default.createElement('div', { className: 'signin-dialog' }, this.state.showSignInDialog ? _react2.default.createElement(_login2.default, { switchToRegister: function switchToRegister() {
    ...
    value: function renderAccountRegistration() {
      ...
      return _react2.default.createElement('div', { className: 'account-registration' }, _react2.default.createElement('button', { className: 'register-button', onClick: function onClick() {
          return _this5.showRegister();
        } }, 'Register'), _react2.default.createElement('button', { className: 'signin-button', onClick: function onClick() {
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', { className: 'home-container' }, _react2.default.createElement('div', { className: 'navbar' }, _react2.default.createElement('a', { href: '/' }, _react2.default.createElement('div', { className: 'home-button' }, 'Noteable')), this.renderAuthenticationOptions(), this.state.showUserOptions ? this.renderUserOptions() : null, this.state.showAccountDialog ? this.renderSignInDialog() : null), _react2.default.createElement('div', { className: 'main-content' }, _react2.default.createElement('div', { className: 'main-background' }), _react2.default.createElement('div', { className: 'header' }, _react2.default.createElement('div', { className: 'header-container' }, _react2.default.createElement('h1', { className: 'header-container__title' }, _react2.default.createElement('span', { className: 'cursor' }, 'Noteable. Be inspired')), _react2.default.createElement('h5', { className: 'header-container__sub-title' }, 'Connect, Create, and Collaborate with artists near you.'), this.props.isAuthenticated ? _react2.default.createElement('div', { className: 'account-registration' }) : this.renderAccountRegistration())), _react2.default.createElement('div', { className: 'connect' }, _react2.default.createElement('div', { className: 'graphic' }), _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement('h1', null, 'Connect'), _react2.default.createElement('div', null, 'Meet other aspiring songwriters as you grow your network. Get to know established or new songwriters and start creating content together right away.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper. Nullam ullamcorper nisi non libero laoreet, id pulvinar augue sodales. Suspendisse hendrerit venenatis mattis.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper.'))), _react2.default.createElement('div', { className: 'collaborate' }, _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement('h1', null, 'Collaborate'), _react2.default.createElement('div', null, 'Meet other aspiring songwriters as you grow your network. Get to know established or new songwriters and start creating content together right away.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper. Nullam ullamcorper nisi non libero laoreet, id pulvinar augue sodales. Suspendisse hendrerit venenatis mattis.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper.')), _react2.default.createElement('div', { className: 'graphic' })), _react2.default.createElement('div', { className: 'create' }, _react2.default.createElement('div', { className: 'graphic' }), _react2.default.createElement('div', { className: 'content' }, _react2.default.createElement('h1', null, 'Create'), _react2.default.createElement('div', null, 'Meet other aspiring songwriters as you grow your network. Get to know established or new songwriters and start creating content together right away.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper. Nullam ullamcorper nisi non libero laoreet, id pulvinar augue sodales. Suspendisse hendrerit venenatis mattis.'), _react2.default.createElement('div', null, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut placerat neque quis enim convallis, non accumsan nunc posuere. Nam pulvinar laoreet volutpat. Quisque vitae fringilla tellus, quis eleifend diam. Duis eget nisl et metus porta faucibus. Maecenas efficitur eu erat et semper.'))), _react2.default.createElement('a', { href: '/contact' }, _react2.default.createElement('div', { className: 'signin-button contact', style: { 'margin-right': '10px' } }, 'Contact Us'))));
    }
  }]);
...
module.exports = function (_React$Component) {
  ...
  _createClass(MessageFeed, [{
    ...
    value: function renderMessage(message) {
      ...
      return React.createElement('li', { className: 'message-feed__message message-collection ' + classId + ' ' + (message.userId === this.props.currentUserId ? 'message-feed__message--me' : '') }, message.content);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return React.createElement('ul', { className: 'message-feed' }, this.props.messages.map(function (message) {
...
module.exports = (_temp = _class = function (_Component) {
  ...
  _createClass(ProfileCreate, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'app-container' }, _react2.default.createElement('div', { className: 'navbar' }, _react2.default.createElement('a', { href: '/' }, _react2.default.createElement('div', { className: 'home-button' }, 'Noteable'))), _react2.default.createElement('div', { className: 'edit-profile-container' }, _react2.default.createElement('h1', { className: 'edit-profile-container__header' }, 'Hey ', this.props.name, ', tell us a little bit about yourself'), _react2.default.createElement('div', { className: 'edit-profile-container__field__instruments--header' }, 'What instruments do you play?'), _react2.default.createElement('div', { className: 'edit-profile-container__field__instruments--submit-button', onClick: function onClick() {
          return _this2.props.savePreferences();
        } }, 'Next'), _react2.default.createElement('ul', { className: 'edit-profile-container__field__instruments' }, instrumentKeys.map(function (key) {
        var instrument = instrumentList[key];

        return _react2.default.createElement('li', { className: 'edit-profile-container__field__instruments--instrument', key: instrument, onClick: function onClick() {
        ...
        }), _react2.default.createElement('label', { htmlFor: instrument }, instrument));
      }))));
    }
  }]);
...
var Profile = function (_React$Component) {
  ...
  _createClass(Profile, [{
    key: 'render',
    value: function render() {
      return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'profile-three' }, _react2.default.createElement('div', { className: 'navbar' }), _react2.default.createElement('div', { className: 'profile-container' }, _react2.default.createElement('div', { className: 'user-info-container' }, _react2.default.createElement('div', { className: 'darken' }), _react2.default.createElement('div', { className: 'user-info__avatar' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('div', { className: 'user-info' }, _react2.default.createElement('div', { className: 'user-info__username' }, 'Michael Nakayama'), _react2.default.createElement('div', { className: 'user-info__name' }, 'Sportnak \u2022 '), _react2.default.createElement('div', { className: 'user-info__location' }, 'Bellingham, WA'), _react2.default.createElement('div', { className: 'action-container' }, _react2.default.createElement('a', { href: '#' }, _react2.default.createElement('div', { className: 'action' }, 'Follow')), _react2.default.createElement('a', { href: '#' }, _react2.default.createElement('div', { className: 'action' }, 'Message')))), _react2.default.createElement('div', { className: 'user-info-actions' }, _react2.default.createElement('div', { className: 'after', style: { left: '50%' } }), _react2.default.createElement('a', { className: 'user-info-actions__events', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '158'), ' Events')), _react2.default.createElement('a', { className: 'user-info-actions__followers user-info-actions__active', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '2.4k'), ' Followers')), _react2.default.createElement('a', { className: 'user-info-actions__following', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '152'), ' Following')))), _react2.default.createElement('ol', { className: 'information-container' }, _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' }))))), _react2.default.createElement('div', { className: 'profile-two' }, _react2.default.createElement('div', { className: 'navbar' }), _react2.default.createElement('div', { className: 'profile-container' }, _react2.default.createElement('div', { className: 'user-info-container' }, _react2.default.createElement('div', { className: 'user-info__avatar' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('div', { className: 'user-info' }, _react2.default.createElement('div', { className: 'user-info__username' }, 'Michael Nakayama'), _react2.default.createElement('div', { className: 'user-info__name' }, 'Sportnak \u2022 '), _react2.default.createElement('div', { className: 'user-info__location' }, 'Bellingham, WA'), _react2.default.createElement('div', { className: 'action-container' }, _react2.default.createElement('a', { href: '#' }, _react2.default.createElement('div', { className: 'action' }, 'Follow')), _react2.default.createElement('a', { href: '#' }, _react2.default.createElement('div', { className: 'action' }, 'Message')))), _react2.default.createElement('div', { className: 'user-info-actions' }, _react2.default.createElement('div', { className: 'after', style: { left: '50%' } }), _react2.default.createElement('a', { className: 'user-info-actions__events', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '158'), ' Events')), _react2.default.createElement('a', { className: 'user-info-actions__followers user-info-actions__active', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '2.4k'), ' Followers')), _react2.default.createElement('a', { className: 'user-info-actions__following', href: '#' }, _react2.default.createElement('div', null, _react2.default.createElement('strong', null, '152'), ' Following'))), _react2.default.createElement('ol', { className: 'information-container' }, _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/v/t1.0-1/p320x320/11107741_10205918346213366_4095323511478631692_n.jpg?oh=924b4d2bc55deae8bd2357d1369093ed&oe=57B02620' }), _react2.default.createElement('div', { className: 'user-information' }, _react2.default.createElement('div', { className: 'user-information__name' }, _react2.default.createElement('strong', null, 'Ian Mundy')), _react2.default.createElement('div', { classname: 'user-information__location' }, 'Nashville, TN'))), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })), _react2.default.createElement('li', { className: 'user' }, _react2.default.createElement('img', { src: 'https://scontent.fsnc1-1.fna.fbcdn.net/hprofile-xfp1/v/t1.0-1/p320x320/12472296_10156709861090621_8977337434395538039_n.jpg?oh=3266682a4859073eb14e4e86ccab8c1c&oe=57A69AE4' })))), _react2.default.createElement('div', { className: 'user-display-container' }))));
    }
  }]);
...
var NavigationSidebar = function (_Component) {
  ...
  _createClass(NavigationSidebar, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'navigation-sidebar' }, _react2.default.createElement('div', { className: 'navigation-sidebar__content' }, _react2.default.createElement('div', { className: 'navigation-sidebar__content__filter-bar-container' }, _react2.default.createElement('input', { className: 'navigation-sidebar__content__filter-bar', onFocus: function onFocus(event) {
          return _this2.focusSearch(event);
        }, onBlur: function onBlur(event) {
          return _this2.blurSearch(event);
        }, placeholder: 'Search' })), _react2.default.createElement('div', { className: 'navigation-sidebar__content__options' }, _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option ' + (activeTab.indexOf('profile') !== -1 || activeTab.length === 0 ? 'active-tab' : ''), onClick: function onClick(event) {
          event.stopPropagation();_this2.props.navigate('profile');
        } }, _react2.default.createElement('div', null, 'Home'), activeTab.indexOf('profile') === -1 && activeTab.length !== 0 ? null : _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option__suboptions' }, _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option__suboptions--option ' + (activeTab.indexOf('view') !== -1 ? 'active-tab' : ''), onClick: function onClick(event) {
          event.stopPropagation();_this2.props.navigate('profileview');
        } }, 'Profile'), _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option__suboptions--option ' + (activeTab.indexOf('settings') !== -1 ? 'active-tab' : ''), onClick: function onClick(event) {
          event.stopPropagation();_this2.props.navigate('profilesettings');
        } }, 'Settings'))), _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option ' + (activeTab === 'documents' ? 'active-tab' : ''), onClick: function onClick() {
          return _this2.props.navigate('documents');
        } }, 'Documents'), activeTab !== 'documents' ? null : _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option__sub-options' }), _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option ' + (activeTab === 'messages' ? 'active-tab' : ''), onClick: function onClick() {
          return _this2.props.navigate('messages');
        } }, 'Messages'), _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option ' + (activeTab === 'events' ? 'active-tab' : ''), onClick: function onClick() {
          return _this2.props.navigate('events');
        } }, 'Events'), activeTab !== 'events' ? null : _react2.default.createElement('div', { className: 'navigation-sidebar__content__options--option__sub-options' }))));
    }
  }]);
...
var ProfileSettings = function (_Component) {
  ...
  _createClass(ProfileSettings, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'profile-settings' }, _react2.default.createElement('div', { className: 'profile-settings__close-icon', onClick: function onClick() {
          return _this2.props.closeSettings();
        } }, _react2.default.createElement(_commonIcons.CrossIcon, null)), _react2.default.createElement('form', { className: 'uploader', encType: 'multipart/form-data' }, _react2.default.createElement('div', { className: 'profile-settings__avatar', style: { backgroundImage: 'url(\'' + this.state.profile.avatarUrl + '\'' } }), _react2.default.createElement('div', { className: 'profile-settings__upload-button', onClick: function onClick() {
          _this2._file.click();
        } }, _react2.default.createElement(_commonIcons.CameraIcon, null)), _react2.default.createElement('input', { className: 'profile-settings__file-upload', ref: function ref(_ref2) {
          _this2._file = _ref2;
        }, type: 'file', name: 'file', onChange: function onChange() {
          return _this2.changeAvatar(_this2._file.files[0]);
        } })), _react2.default.createElement('div', { className: 'profile-settings__input-container' }, _react2.default.createElement('label', { htmlFor: 'name' }, 'Name: '), _react2.default.createElement('input', {
      ...
      })), _react2.default.createElement('div', { className: 'profile-settings__input-container' }, _react2.default.createElement('label', { htmlFor: 'title' }, 'Profession: '), _react2.default.createElement('input', {
      ...
      })), _react2.default.createElement('div', { className: 'profile-settings__input-container' }, _react2.default.createElement('label', { htmlFor: 'location' }, 'Location: '), _react2.default.createElement('input', {
      ...
      })), _react2.default.createElement('div', { className: 'profile-settings__save', onClick: function onClick() {
...
var Profile = function (_Component) {
  ...
  _createClass(Profile, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'app-container' }, _react2.default.createElement('link', { rel: 'stylesheet', type: 'text/css', href: 'https://cdnjs.cloudflare.com/ajax/libs/draft-js/0.7.0/Draft.min.css' }), _react2.default.createElement('div', { className: 'navbar navbar__no-home' }, _react2.default.createElement('a', { href: '/' }, _react2.default.createElement('div', { className: 'home-button' }, 'Noteable'))), this.state.settingsView ? _react2.default.createElement(_profileSettings2.default, {
      ...
      }) : _react2.default.createElement('div', { className: 'profile-container' }, _react2.default.createElement('div', { className: 'profile-header' }, _react2.default.createElement('div', { className: 'filter', style: { backgroundImage: 'linear-gradient(to bottom, rgba(0, 0, 0, 0.05), rgba(0, 0, 0, 0.45)), url("' + this.props.profile.coverImage + '")' } }), _react2.default.createElement('div', { className: 'profile' }, _react2.default.createElement('span', { className: 'profile__edit-icon', onClick: function onClick() {
          _this4.setState({ settingsView: true });_this4.navigate('profilesettings');
        } }, _react2.default.createElement(_commonIcons.CogIcon, null)), _react2.default.createElement('form', { className: 'uploader', encType: 'multipart/form-data' }, _react2.default.createElement('input', { className: 'profile-settings__file-upload', ref: function ref(_ref2) {
          _this4._coverImage = _ref2;
        }, type: 'file', name: 'file', onChange: function onChange() {
          return _this4.changeCoverImage(_this4._coverImage.files[0]);
        } })), _react2.default.createElement('span', { className: 'profile__camera-icon', alt: 'Change cover image', onClick: function onClick() {
          return _this4._coverImage.click();
        } }, _react2.default.createElement(_commonIcons.CameraIcon, null)), _react2.default.createElement('div', { className: 'profile__image', style: { backgroundImage: 'url(\'' + this.props.profile.avatarUrl + '\'' } }), _react2.default.createElement('div', { className: 'profile__name' }, this.props.profile.name == null ? 'Michael Nakayama' : this.props.profile.name), _react2.default.createElement('div', { className: 'profile__title' }, 'Studying songwriting \u2022 Belmont University'), _react2.default.createElement('div', { className: 'profile__title' }, '1 year experience'), _react2.default.createElement('div', { className: 'profile__location' }, this.props.profile.location == null ? 'Bellingham, WA' : this.props.profile.location), _react2.default.createElement('button', { className: 'profile__follow', onClick: function onClick() {
          return _this4.followUser(_this4.props.profile.id);
        } }, 'Follow'), _react2.default.createElement('button', { className: 'profile__message' }, 'Message')), _react2.default.createElement('div', { className: 'isLooking' }, this.props.profile.isLooking == null ? 'I\'m looking to start a band!' : '')), _react2.default.createElement('div', { className: 'profile-about__nav-bar' }, _react2.default.createElement('a', { href: '#about' }, _react2.default.createElement('button', null, 'About')), _react2.default.createElement('button', { href: '#interests' }, 'Interests'), _react2.default.createElement('button', { href: '#demos' }, 'My demos')), _react2.default.createElement('div', { className: 'profile-about' }, _react2.default.createElement('div', { className: 'about-tab ' + (this.props.location.hash === 'about' || this.props.location.hash === '' ? 'about-tab--active' : '') }, _react2.default.createElement('div', { className: 'profile-about__title' }, 'About Me', _react2.default.createElement('span', { className: 'profile-about__icon', onClick: function onClick() {
          return _this4.setState({ isEditing: true });
        } }, _react2.default.createElement(_commonIcons.PencilIcon, null)), this.props.validation.isValidBio ? '' : _react2.default.createElement('span', { className: 'error profile-about__error-message' }, 'Your about section is too long.')), _react2.default.createElement('div', { className: 'profile-about__container' }, this.state.isEditing ? _react2.default.createElement('div', { className: 'profile-about__container__actions' }, _react2.default.createElement('button', { className: 'profile-about__container__actions--save', onClick: function onClick() {
          return _this4.saveBio();
        } }, 'Save'), _react2.default.createElement('button', { className: 'profile-about__container__actions--cancel', onClick: function onClick() {
          return _this4.closeEditor();
        } }, 'Cancel')) : null, _react2.default.createElement('div', { className: 'profile-about__editor-container ' + (this.state.isEditing ? 'profile-about__editor-container--is-editing' : '') }, _react2.default.createElement(_draftJs.Editor, {
...
module.exports = function (_React$Component) {
  ...
  _createClass(AudioComponent, [{
    ...
    key: 'renderGrid',
    value: function renderGrid() {
      return React.createElement('div', null, React.createElement('div', { className: 'testing-vertical' }), React.createElement('div', { className: 'testing-horizontal' }));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return React.createElement('div', null, React.createElement('div', null, React.createElement('div', { onClick: this.state.isRecording ? function () {
          _this3.stopRecording();
        } : function () {
          _this3.startRecording();
        }, className: 'record-button' }), React.createElement('div', { onClick: function onClick() {
          _this3.stopRecording();
        }, className: 'stop-button' }), React.createElement('audio', { src: this.state.audioUrl, className: 'audio-player', controls: true }), React.createElement('button', { onClick: function onClick() {
...
module.exports = function (_Component) {
  ...
  _createClass(SigninController, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'auth-container', style: this.state.isRegistering ? { height: '350px' } : { height: '300px' } }, this.state.isRegistering ? _react2.default.createElement(_register2.default, { switchToLogin: function switchToLogin() {
...
module.exports = function (_React$Component) {
  ...
  _createClass(SongsController, [{
    ...
    key: 'render',
    value: function render() {
      return React.createElement('div', null, React.createElement('div', { className: 'button-container' }, React.createElement('form', { action: '/editor' }, React.createElement('input', { className: 'create-song', type: 'submit', value: 'Create' }))), React.createElement('div', { className: 'song-list' }, this.state.songData.map(function (song) {
        return React.createElement('div', { className: 'song-list-item' }, React.createElement('div', { className: 'song-list-item-title' }, song.title), React.createElement('div', { className: 'song-list-item-date' }, song.dateCreated));
      })));
    }
  }]);
...
module.exports = function (_React$Component) {
  ...
  _createClass(SuccessDisplayController, [{
    ...
    key: "render",
    value: function render() {
      return React.createElement("div", { className: "success-container", style: { position: "absolute", top: 0, bottom: 0, left: 0, right: 0, margin: "auto" } }, React.createElement("div", null, "SUCCESS"));
    }
  }]);
